...
public class PbEntity
{
    ...
    public static TokenType getStandardTokenType()
    {
    ...
    public static TokenInfo decTokenInfo(byte[] raw)
    {
        ...
        BasicMethods.assert(ti.tokenType <= getStandardTokenType().GAS, "tokenType illegal");
        seek += len;
    ...
    public static ChannelMigrationInfo decChannelMigrationInfo(byte[] raw)
    {
        ...
        cmi.toLedgerAddress = raw.Range(seek, len);
        seek += len;
